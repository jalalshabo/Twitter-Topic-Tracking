...
function Background() {
    ...
    const transcorner = useSpring({ 
        to: {opacity: 0.3 ,marginBottom:globalState? 1000:0, marginRight:0, borderRight:globalState? "1px solid #fff" :"1px solid #000"}, 
        from: {opacity: 0, marginBottom:-400, marginRight:-400},
        delay:globalState?0:500,
    ...
    const datetransition = useSpring({
        to: {opacity:globalState? 1: 0, width:globalState?"10%": "0%"},
        delay: globalState?500: 0,
    ...
    const fadehalf = useSpring({ 
        to: {opacity: globalState? 1 : 0.5, marginBottom: globalState? 800: 0}, 
        from: {opacity: globalState? 0.5:0, marginBottom:0},
        delay:globalState?700:0,
